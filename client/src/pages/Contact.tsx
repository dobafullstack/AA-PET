...
export default function Contact() {
    ...
    const sendMail = (values: typeof initialValues, { resetForm }: any) => {
        console.log(values);
        emailjs
            .send(
            ...
            <div className='section section-margin'>
                <div className='container'>
                    <div className='row mb-n10'>
                        <div
                            className='col-12 col-lg-6 mb-10 order-2 order-lg-1'
                            data-aos='fade-up'
                        ...
                        <div
                            className='col-12 col-lg-6 mb-10 order-1 order-lg-2'
                            data-aos='fade-up'
                        ...
                        >
                            ...
                            <div className='contact-content'>
                                ...
                                <address className='contact-block'>
                                    <ul>
                                        <li>
                                            <i className='fa fa-fax'></i> 11G, 22St, Binh Hung Hoa
                                            A, Binh Tan district
                                        </li>
                                        <li>
                                            <i className='fa fa-phone'></i>{' '}
                                            <a href='tel:123-123-456-789'>0944609933</a>
                                        </li>
                                        <li>
