...
export default function CategoryItem({ product }: Props): ReactElement {
            ...
            <div className='product-inner'>
                <div className='thumb'>
                    <Link to={`/product/${product._id}`} className='image'>
                        <img className='fit-image' src={product.images[0]} alt='Product' width={270} height={270} />
                    </Link>
                    ...
                    <div className='action-wrapper'>
                        <a href='javascript:void;' className='action quickview' data-bs-toggle='modal' data-bs-target='#quick-view' title='Quickview' onClick={dispatchProduct}>
                            <i className='ti-plus'></i>
                        </a>
                        <a href='javascript:void' className='action wishlist' title='Wishlist'>
                            <i className='ti-heart'></i>
                        </a>
                        <a href='javascript:void' className='action cart' title='Cart' onClick={() => dispatch(addToCart({ product, count: 1 }))}>
                    ...
                    <div className='cart-btn action-btn'>
                        <div className='action-cart-btn-wrapper d-flex'>
                            <div className='add-to_cart'>
                                <a className='btn btn-primary btn-hover-dark rounded-0' href='javascript:void' onClick={() => dispatch(addToCart({ product, count: 1 }))}>
                                    Add to cart
                                </a>
                            </div>
