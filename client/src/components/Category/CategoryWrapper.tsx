...
export default function CategoryWrapper({products}: Props): ReactElement {

    if (products.length === 0) return <div className='col-lg-9 col-12'><p style={{fontSize: 30, textAlign: 'center'}}>Không có sản phẩm</p></div>
          ...
          <div className='shop_toolbar_wrapper flex-column flex-md-row p-2 mb-8 border'>
              <div className='shop-top-bar-left'>
                  <div className='shop_toolbar_btn'>
                      <button data-role='grid_3' type='button' className='active btn-grid-3' title='Grid'>
                          <i className='ti-layout-grid4-alt'></i>
                      </button>
                      <button data-role='grid_list' type='button' className='btn-list' title='List'>
