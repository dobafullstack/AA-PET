...
export default function ProductItem({ newProduct, saleProduct }: Props): ReactElement {
  return (
    <div className='product'>
      <div className='thumb'>
        <Link to='/product'>
          <img className='fit-image' src={demoImg} alt='Product' />
        </Link>
        {saleProduct && (
        ...
        <div className='action-wrapper'>
          <a href='#/' className='action quickview' data-bs-toggle='modal' data-bs-target='#quick-view'>
            <i className='ti-plus'></i>
          </a>
          <a href='wishlist.html' className='action wishlist' title='Wishlist'>
            <i className='ti-heart'></i>
          </a>
          <a href='cart.html' className='action cart' title='Cart'>
